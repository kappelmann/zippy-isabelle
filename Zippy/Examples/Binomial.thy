...
text \<open>The absorption identity (equation 5.5 ):
\[
...
text \<open>
  Equation 5.9 of the reference material  is a useful
...
text \<open>
  Another summation formula is equation 5.10 of the reference material ,
