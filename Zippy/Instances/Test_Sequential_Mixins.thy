...
ML\<open>
  ...
  struct
    ...
    in
      structure ZN = Instantiate_Zippy_Node_1(open Base; structure Z = ZN)
      structure ZL = Instantiate_Zippy_Lists_1(open Base; structure Z = ZL)
      fun content1 m = update_content old_content DataM.data_more m
    end
    ...
    in
      structure ZN = Instantiate_Zippy_Node_2(open Base; structure Z = ZN)
      structure ZL = Instantiate_Zippy_Lists_2(open Base; structure Z = ZL)
      structure GClusters =
      struct
        local
          structure Base = Instantiate_Zippy_Goal_Clusters_Mixin_Base_2(
            open Base; structure GClusters = GClusters)
          structure More = Zippy_Goal_Clusters_Mixin(Base)
        in open GClusters Base More end
      end
      fun content2 m = update_content old_content DataM.data_more m
    end
...
ML_val\<open>
  ...
  in
  val aan1 = ZNB.node_no_next5 () (closed_content5 0 AActionAN.AAN.init)
  ...
  val an2 = ZNB.node_no_next4 () (closed_content4 ActionAN.AAN.init presults pact)
