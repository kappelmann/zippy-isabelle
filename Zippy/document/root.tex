...
\begin{abstract}
This entry contains Zippy, a framework for tree-based searches.
...
This entry also provides a concrete instantiation of the framework in the form of a general purpose white-box prover,
called \emph{Zippy Auto}, or \emph{zippy} for short.
...
By default, it integrates the classical reasoner, simplifier, the blast prover,
...
In most cases, zippy can be used as a drop-in replacement for Isabelle's classical methods, including
auto, fastforce, force, fast, etc. We demonstrate this with a benchmark containing 2267 method calls
from Isabelle's standard library, where zippy achieves a success rate of 99.82\% (2263/2267).
